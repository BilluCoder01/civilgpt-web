              ...
              <div className="leading-relaxed">
                {m.role === 'user' ? (
                  ...
                  <ReactMarkdown
                    ...
                    components={{
                      // Added generous top/bottom margins and distinct borders to headings
                      ...
                      // Added leading-loose for better text readability
                      p: ({node, ...props}) => <p className="mb-4 leading-relaxed" {...props} />,
                      // Expanded list spacing from space-y-1 to space-y-4
                      ul: ({node, ...props}) => <ul className="list-disc pl-6 mb-6 space-y-4" {...props} />,
                      ol: ({node, ...props}) => <ol className="list-decimal pl-6 mb-6 space-y-4" {...props} />,
                      // Forced list items to have relaxed line heights so tall math equations fit comfortably
